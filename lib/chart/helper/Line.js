...
function setLinePoints(targetShape, points) {
  ...
  if (cp2 && Array.isArray(cp2)) {
    targetShape.cpx2 = cp2[0];
    targetShape.cpy2 = cp2[1];
  } else {// Milley : this part must be commented out
    // otherwise will impact "2 nondes with multiple lines" case -> no line display
    // targetShape.cpx2 = NaN;
    // targetShape.cpy2 = NaN;
  }
}
